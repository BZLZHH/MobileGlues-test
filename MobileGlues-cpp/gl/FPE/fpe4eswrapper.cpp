...
// void APIENTRY_FPE4ES fpe4es_glBlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha);
void APIENTRY_FPE4ES fpe4es_glBlendEquationSeparatei(GLuint buf, GLenum modeRGB, GLenum modeAlpha);
// void APIENTRY_FPE4ES fpe4es_glBlendFuncSeparate(GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
void APIENTRY_FPE4ES fpe4es_glBlendFuncSeparatei(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha,
                                                 GLenum dstAlpha);
// void APIENTRY_FPE4ES fpe4es_glColorMaterial(GLenum face, GLenum mode);
void APIENTRY_FPE4ES fpe4es_glCopyPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum type);
void APIENTRY_FPE4ES fpe4es_glDrawBuffer(GLenum mode);
void APIENTRY_FPE4ES fpe4es_glEdgeFlag(GLboolean flag);
...
// void APIENTRY_FPE4ES fpe4es_glGetTexImage(GLenum target, GLint level, GLenum format, GLenum type, GLvoid * img);
// void APIENTRY_FPE4ES fpe4es_glGetTexLevelParameterfv(GLenum target, GLint level, GLenum pname, GLfloat *params);
// void APIENTRY_FPE4ES fpe4es_glGetTexLevelParameteriv(GLenum target, GLint level, GLenum pname, GLint *params);
void APIENTRY_FPE4ES fpe4es_glIndexf(GLfloat c);
void APIENTRY_FPE4ES fpe4es_glLightModeli(GLenum pname, GLint param);
void APIENTRY_FPE4ES fpe4es_glPolygonStipple(const GLubyte* mask);
void APIENTRY_FPE4ES fpe4es_glReadBuffer(GLenum mode);
void APIENTRY_FPE4ES fpe4es_glSecondaryColor3f(GLfloat r, GLfloat g, GLfloat b);
void APIENTRY_FPE4ES fpe4es_glColorTable(GLenum target, GLenum internalformat, GLsizei width, GLenum format,
                                         GLenum type, const GLvoid* table);
// void APIENTRY_FPE4ES fpe4es_glIndexPointer(GLenum  type,  GLsizei  stride,  const GLvoid *  pointer);

void APIENTRY_FPE4ES fpe4es_glAccum(GLenum op, GLfloat value);
void APIENTRY_FPE4ES fpe4es_glPrioritizeTextures(GLsizei n, const GLuint* textures, const GLclampf* priorities);
...
void APIENTRY_FPE4ES fpe4es_glPassThrough(GLfloat token);
void APIENTRY_FPE4ES fpe4es_glIndexMask(GLuint mask);
...
void APIENTRY_FPE4ES fpe4es_glClearIndex(GLfloat c);
void APIENTRY_FPE4ES fpe4es_glGetPolygonStipple(GLubyte* pattern);
void APIENTRY_FPE4ES fpe4es_glFeedbackBuffer(GLsizei size, GLenum type, GLfloat* buffer);
void APIENTRY_FPE4ES fpe4es_glEdgeFlagv(GLboolean* flag);
...
void APIENTRY_FPE4ES fpe4es_glClipPlane(GLenum plane, const GLdouble* equation) {
    ...
    fpe4es_glClipPlanef(plane, s);
}
void APIENTRY_FPE4ES fpe4es_glDepthRange(GLdouble nearVal, GLdouble farVal) {
    fpe4es_glDepthRangef(nearVal, farVal);
}
void APIENTRY_FPE4ES fpe4es_glFogi(GLenum pname, GLint param) {
    fpe4es_glFogf(pname, param);
}
void APIENTRY_FPE4ES fpe4es_glFogiv(GLenum pname, GLint* iparams) {
    switch (pname) {
    case GL_FOG_DENSITY:
    case GL_FOG_START:
    case GL_FOG_END:
...
void APIENTRY_FPE4ES fpe4es_glGetTexGendv(GLenum coord, GLenum pname, GLdouble* params) {
    GLfloat fparams[4];
    fpe4es_glGetTexGenfv(coord, pname, fparams);
...
void APIENTRY_FPE4ES fpe4es_glGetMaterialiv(GLenum face, GLenum pname, GLint* params) {
    GLfloat fparams[4];
    fpe4es_glGetMaterialfv(face, pname, fparams);
...
void APIENTRY_FPE4ES fpe4es_glGetLightiv(GLenum light, GLenum pname, GLint* params) {
    GLfloat fparams[4];
    fpe4es_glGetLightfv(light, pname, fparams);
    int n = 4;
    switch (pname) {
...
void APIENTRY_FPE4ES fpe4es_glGetTexLevelParameteriv(GLenum target, GLint level, GLenum pname, GLint* params) {
    GLfloat fparams[4];
    fpe4es_glGetTexLevelParameterfv(target, level, pname, fparams);
...
void APIENTRY_FPE4ES fpe4es_glLightiv(GLenum light, GLenum pname, GLint* iparams) {
    ...
    case GL_SPECULAR:
        ...
        fpe4es_glLightfv(light, pname, params);
        break;
    case GL_POSITION:
        for (int i = 0; i < 4; i++) {
            params[i] = iparams[i];
    ...
    case GL_LINEAR_ATTENUATION:
    case GL_QUADRATIC_ATTENUATION: {
        fpe4es_glLightf(light, pname, *iparams);
        break;
    }
    }
}
...
void APIENTRY_FPE4ES fpe4es_glLightModeli(GLenum pname, GLint param) {
    fpe4es_glLightModelf(pname, param);
}
void APIENTRY_FPE4ES fpe4es_glLightModeliv(GLenum pname, GLint* iparams) {
    ...
    case GL_LIGHT_MODEL_AMBIENT: {
        ...
        fpe4es_glLightModelfv(pname, params);
        break;
    }
    case GL_LIGHT_MODEL_LOCAL_VIEWER:
    case GL_LIGHT_MODEL_TWO_SIDE: {
        fpe4es_glLightModelf(pname, *iparams);
        break;
    }
    }
}
...
void APIENTRY_FPE4ES fpe4es_glMateriali(GLenum face, GLenum pname, GLint param) {
    fpe4es_glMaterialf(face, pname, param);
}
void APIENTRY_FPE4ES fpe4es_glMaterialiv(GLenum face, GLenum pname, GLint* iparams) {
    ...
    case GL_AMBIENT_AND_DIFFUSE: {
        ...
        fpe4es_glMaterialfv(face, pname, params);
        break;
    }
    case GL_SHININESS: {
        fpe4es_glMaterialf(face, pname, *iparams);
        break;
    }
...
void APIENTRY_FPE4ES fpe4es_glOrtho(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble Near,
                                    GLdouble Far) {
    fpe4es_glOrthof(left, right, bottom, top, Near, Far);
}
...
void APIENTRY_FPE4ES glClipPlanefOES(GLenum plane, const GLfloat* equation) {
    fpe4es_glClipPlanef(plane, equation);
}
void APIENTRY_FPE4ES glDepthRangefOES(GLclampf Near, GLclampf Far) {
    fpe4es_glDepthRangef(Near, Far);
}
void APIENTRY_FPE4ES glFrustumfOES(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat Near,
                                   GLfloat Far) {
    fpe4es_glFrustumf(left, right, bottom, top, Near, Far);
}
void APIENTRY_FPE4ES glGetClipPlanefOES(GLenum pname, GLfloat equation[4]) {
    fpe4es_glGetClipPlanef(pname, equation);
}
...
#define GL_RECT(suffix, type)                                                                                          \
    void APIENTRY_FPE4ES fpe4es_glRect##suffix(type x1, type y1, type x2, type y2) {                                   \
        fpe4es_glBegin(GL_QUADS);                                                                                      \
        fpe4es_glVertex2##suffix(x1, y1);                                                                              \
        fpe4es_glVertex2##suffix(x2, y1);                                                                              \
        fpe4es_glVertex2##suffix(x2, y2);                                                                              \
        fpe4es_glVertex2##suffix(x1, y2);                                                                              \
        fpe4es_glEnd();                                                                                                \
    }                                                                                                                  \
    void APIENTRY_FPE4ES fpe4es_glRect##suffix##v(const type* v1, const type* v2) {                                    \
        fpe4es_glRect##suffix(v1[0], v1[1], v2[0], v2[1]);                                                             \
    }
...
#define THUNK(suffix, type, invmax)                                                                                    \
    ...
    void APIENTRY_FPE4ES fpe4es_glMultiTexCoord4##suffix(GLenum target, type s, type t, type r, type q) {              \
        fpe4es_glMultiTexCoord4f(target, s, t, r, q);                                                                  \
    }                                                                                                                  \
...
void APIENTRY_FPE4ES fpe4es_glTexCoord2fv(GLfloat* t) {
    //    fpe4es_glTexCoord4f(t[0], t[1], 0, 1);
    fpe4es_glMultiTexCoord2fv(GL_TEXTURE0, t);
}
...
void APIENTRY_FPE4ES fpe4es_glTexGendv(GLenum coord, GLenum pname, const GLdouble* params) {
    ...
    if ((pname == GL_OBJECT_PLANE) || (pname == GL_EYE_PLANE))
        for (int i = 1; i < 4; i++)
            tmp[i] = params[i];
    fpe4es_glTexGenfv(coord, pname, tmp);
}
...
void APIENTRY_FPE4ES fpe4es_glBlendEquationSeparatei(GLuint buf, GLenum modeRGB, GLenum modeAlpha) {
    ...
    // TODO: handle buf
    fpe4es_glBlendEquationSeparate(modeRGB, modeAlpha);
}
...
void APIENTRY_FPE4ES fpe4es_glBlendFuncSeparatei(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha,
    ...
    // ignore buf is better than nothing..
    // TODO: handle buf
    fpe4es_glBlendFuncSeparate(srcRGB, dstRGB, srcAlpha, dstAlpha);
}

#undef constDoubleToFloat

void APIENTRY_FPE4ES fpe4es_glGetTexParameterfv(GLenum target, GLenum pname, GLfloat* params) {
    fpe4es_glGetTexLevelParameterfv(target, 0, pname, params);
}

void APIENTRY_FPE4ES fpe4es_glGetTexParameteriv(GLenum target, GLenum pname, GLint* params) {
    fpe4es_glGetTexLevelParameteriv(target, 0, pname, params);
}

// Samples stuff
#include "../loader.h"
void APIENTRY_FPE4ES fpe4es_glSampleCoverage(GLclampf value, GLboolean invert) {
...
// VertexArray stuff
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1f(GLuint index, GLfloat v0) {
    GLfloat f[4] = {0, 0, 0, 1};
    f[0] = v0;
    fpe4es_glVertexAttrib4fv(index, f);
};
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2f(GLuint index, GLfloat v0, GLfloat v1) {
    GLfloat f[4] = {0, 0, 0, 1};
    f[0] = v0;
    f[1] = v1;
    fpe4es_glVertexAttrib4fv(index, f);
};
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3f(GLuint index, GLfloat v0, GLfloat v1, GLfloat v2) {
    GLfloat f[4] = {0, 0, 0, 1};
    f[0] = v0;
    f[1] = v1;
    f[2] = v2;
...
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1fv(GLuint index, const GLfloat* v) {
    GLfloat f[4] = {0, 0, 0, 1};
    f[0] = v[0];
    fpe4es_glVertexAttrib4fv(index, f);
};
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2fv(GLuint index, const GLfloat* v) {
    GLfloat f[4] = {0, 0, 0, 1};
    f[0] = v[0];
    f[1] = v[1];
    fpe4es_glVertexAttrib4fv(index, f);
};
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3fv(GLuint index, const GLfloat* v) {
    GLfloat f[4] = {0, 0, 0, 1};
    f[0] = v[0];
    f[1] = v[1];
    f[2] = v[2];
...
// AliasExport(void,glDrawRangeElements,,(GLenum mode,GLuint start,GLuint end,GLsizei count,GLenum type,const void
// *indices));
...
// AliasExport(void,glDrawRangeElements,EXT,(GLenum mode,GLuint start,GLuint end,GLsizei count,GLenum type,const void
// *indices));
