#ifndef _FPE4ES_LIST_H_
#define _FPE4ES_LIST_H_
...
#define NewStage(l, s)                                                                                                 \
    if (l->stage + StageExclusive[l->stage] > s) {                                                                     \
        l = extend_renderlist(l);                                                                                      \
    }                                                                                                                  \
    l->stage = s

renderlist_t* GetFirst(renderlist_t* list);

#define alloc_sublist(n, cap) (GLfloat*)malloc(n * sizeof(GLfloat) * cap)

#define realloc_sublist(ref, n, cap)                                                                                   \
    if (ref) ref = (GLfloat*)realloc(ref, n * sizeof(GLfloat) * cap)
