...
#define _EX(func_name) MAP(#func_name, fpe4es_##func_name)

#define _ARB(func_name) MAP(#func_name "ARB", fpe4es_##func_name)

#define _EXT(func_name) MAP(#func_name "EXT", fpe4es_##func_name)
...
#define STUB(func_name)                                                                                                \
    if (strcmp(name, #func_name) == 0) {                                                                               \
        printf("=> STUB\n");                                                                                           \
        if (!globals4es.silentstub) LOGD("FPE4ES stub: %s\n", #func_name);                                             \
...
NonAliasExportDecl(void*, fpe4es_GetProcAddress, (const char* name));
