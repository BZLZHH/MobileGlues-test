...
void APIENTRY_FPE4ES fpe4es_glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width,
    ...
    DBG(printf("glCompressedTexImage2D on target=%s:%p, level=%d with size(%i,%i), internalformat=%s, imagesize=%i, "
    ...
    if (isDXTc(internalformat)) {
        ...
        int oldalign;
        fpe4es_glGetIntegerv(GL_UNPACK_ALIGNMENT, &oldalign);
        if (oldalign != 1) fpe4es_glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
        ...
        fpe4es_glTexImage2D(target, level, new_intformat, width, height, border, format, type, half);
        ...
        if (level) {
            ...
            while (nww != 1 || nhh != 1) {
                ...
                ++leveln;
                fpe4es_glTexImage2D(target, leveln, new_intformat, nww, nhh, border, format, type, out);
                if (out != ndata) free(out);
            }
            bound->mipmap_auto = 1;
        }

        if (oldalign != 1) fpe4es_glPixelStorei(GL_UNPACK_ALIGNMENT, oldalign);
...
void APIENTRY_FPE4ES fpe4es_glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
    ...
    gltexture_t* bound = glstate->texture.bound[glstate->texture.active][itarget];
    DBG(printf("glCompressedTexSubImage2D with unpack_row_length(%i), level=%d, size(%i,%i), pos(%i,%i) and "
    ...
    if (isDXTc(format)) {
        ...
        fpe4es_glGetIntegerv(GL_UNPACK_ALIGNMENT, &oldalign);
        if (oldalign!=1) fpe4es_glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
        fpe4es_glTexSubImage2D(target, level, xoffset/2, yoffset/2, width/2, height/2, GL_RGBA, GL_UNSIGNED_SHORT_4_4_4_4, half);
        if (oldalign!=1) fpe4es_glPixelStorei(GL_UNPACK_ALIGNMENT, oldalign);
#else
        DBG(printf(" [%d] => (Alpha=%d/%d), %dx%d %s/%s\n\n", bound->glname, simpleAlpha, complexAlpha, width, height,
                   PrintEnum(bound->format), PrintEnum(bound->type));)
        fpe4es_glTexSubImage2D(target, level, xoffset, yoffset, width, height, GL_RGBA, GL_UNSIGNED_BYTE, half);
#endif
        if (half != pixels) free(half);
        if (pixels != datab) free(pixels);
    } else {
...
void APIENTRY_FPE4ES fpe4es_glGetCompressedTexImage(GLenum target, GLint lod, GLvoid* img) {
    ...
    fpe4es_glGetTexImage(target, lod, GL_RGBA, GL_UNSIGNED_BYTE, (GLvoid*)src);
...
void APIENTRY_FPE4ES fpe4es_glCompressedTexImage1D(GLenum target, GLint level, GLenum internalformat, GLsizei width,
    ...
    fpe4es_glCompressedTexImage2D(target, level, internalformat, width, 1, border, imageSize, data);
}
...
void APIENTRY_FPE4ES fpe4es_glCompressedTexImage3D(GLenum target, GLint level, GLenum internalformat, GLsizei width,
    ...
    fpe4es_glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data);
}

void APIENTRY_FPE4ES fpe4es_glCompressedTexSubImage1D(GLenum target, GLint level, GLint xoffset, GLsizei width,
                                                      GLenum format, GLsizei imageSize, const GLvoid* data) {

    fpe4es_glCompressedTexSubImage2D(target, level, xoffset, 0, width, 1, format, imageSize, data);
}
void APIENTRY_FPE4ES fpe4es_glCompressedTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
                                                      GLint zoffset, GLsizei width, GLsizei height, GLsizei depth,
                                                      GLenum format, GLsizei imageSize, const GLvoid* data) {

    fpe4es_glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data);
}
