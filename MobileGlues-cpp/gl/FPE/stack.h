#ifndef _FPE4ES_STACK_H_
#define _FPE4ES_STACK_H_

#include "state.h"
#include "texture.h"
#define STACK_SIZE 16

#define FPE4ES_HINT_FIRST GL_SHRINK_HINT_FPE4ES
#define FPE4ES_HINT_LAST (GL_NOERROR_HINT_FPE4ES + 1)
