#ifndef _FPE4ES_SHADER_H_
#define _FPE4ES_SHADER_H_
...
void APIENTRY_FPE4ES fpe4es_glGetShaderPrecisionFormat(GLenum shaderType, GLenum precisionType, GLint* range,
                                                       GLint* precision);
void APIENTRY_FPE4ES fpe4es_glShaderBinary(GLsizei count, const GLuint* shaders, GLenum binaryFormat,
