...
void APIENTRY_FPE4ES fpe4es_glTexImage3D(GLenum target, GLint level, GLint internalFormat, GLsizei width,
    ...
    fpe4es_glTexImage2D(GL_TEXTURE_3D, level, internalFormat, width, height, border, format, type, data);
}
void APIENTRY_FPE4ES fpe4es_glTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
    ...
    fpe4es_glTexSubImage2D(GL_TEXTURE_3D, level, xoffset, yoffset, width, height, format, type, data);
}
...
void APIENTRY_FPE4ES fpe4es_glTexStorage3D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width,
    ...
    DBG(printf("glTexStorage3D(%s, %d, %s, %d, %d, %d)\n", PrintEnum(target), levels, PrintEnum(internalformat), width,
               height, depth);)
    fpe4es_glTexImage3D(target, 0, internalformat, width, height, depth, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
}
...
void APIENTRY_FPE4ES fpe4es_glCopyTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
    ...
    fpe4es_glCopyTexSubImage2D(GL_TEXTURE_3D, level, xoffset, yoffset, x, y, width, height);
}
