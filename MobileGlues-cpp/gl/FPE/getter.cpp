...
GLenum APIENTRY_FPE4ES fpe4es_glGetError(void) {
    DBG(printf("glGetError(), noerror=%d, type_error=%d shim_error=%s\n", globals4es.noerror, glstate->type_error,
               PrintEnum(glstate->shim_error));)
...
void BuildExtensionsList() {
    if (!glstate->extensions) {
        ...
        strcpy(
            ...
            "GL_EXT_compiled_vertex_arrays " // yes, at least on AmigaOS there are progs which check for this wrong
                                             // string; reason is an old typo in the MiniGL driver.
...
extern char* fpe4es_original_vendor;
extern char* fpe4es_original_renderer;
...
const GLubyte* APIENTRY_FPE4ES fpe4es_glGetString(GLenum name) {
    ...
    case GL_VENDOR:
        if (!vendor_string[0]) {
            snprintf(vendor_string, 127, "FPE4ES wrapping %s",
                     fpe4es_original_vendor ? fpe4es_original_vendor : "an unknown hardware");
        }
        return (GLubyte*)vendor_string;
    case GL_RENDERER:
        if (!renderer_string[0]) {
            snprintf(renderer_string, 127, "FPE4ES using %s",
                     fpe4es_original_renderer ? fpe4es_original_renderer : "an unknown renderer");
        }
        return (GLubyte*)renderer_string;
    case GL_SHADING_LANGUAGE_VERSION:
        if (globals4es.gl == 21)
            return (GLubyte*)"1.20 via fpe4es";
        else if (globals4es.gl == 20)
            return (GLubyte*)"1.10 via fpe4es";
        return (GLubyte*)"";
...
int fpe4es_commonGet(GLenum pname, GLfloat* params) {
    switch (pname) {
...
void APIENTRY_FPE4ES fpe4es_glGetIntegerv(GLenum pname, GLint* params) {
    ...
    noerrorShim();
    GLfloat fparam;
    if (fpe4es_commonGet(pname, &fparam)) {
        params[0] = fparam;
        return;
    }
    gltexture_t* tex;
...
void APIENTRY_FPE4ES fpe4es_glGetFloatv(GLenum pname, GLfloat* params) {
    ...
    noerrorShim();
    if (fpe4es_commonGet(pname, params)) {
        return;
    }
...
void APIENTRY_FPE4ES fpe4es_glGetLightfv(GLenum light, GLenum pname, GLfloat* params) {
...
void APIENTRY_FPE4ES fpe4es_glGetMaterialfv(GLenum face, GLenum pname, GLfloat* params) {
...
void APIENTRY_FPE4ES fpe4es_glGetClipPlanef(GLenum plane, GLfloat* equation) {
...
// const GLubyte* APIENTRY_FPE4ES fpe4es_glGetStringi(GLenum name, GLuint index) {
...
void fpe4es_glGetMinmaxParameteriv(GLenum target, GLenum pname, GLint* params) {
...
void fpe4es_glGetMinmaxParameterfv(GLenum target, GLenum pname, GLfloat* params) {
