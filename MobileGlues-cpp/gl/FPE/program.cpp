...
void APIENTRY_FPE4ES fpe4es_glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length,
...
void APIENTRY_FPE4ES fpe4es_glGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length,
                                               GLint* size, GLenum* type, GLchar* name) {
...
int fpe4es_useProgramBinary(GLuint program, int length, GLenum format, const void* binary) {
...
int fpe4es_getProgramBinary(GLuint program, int* length, GLenum* format, void** binary) {
    if (hardext.prgbin_n == 0) return 0;
...
/*
void APIENTRY_FPE4ES fpe4es_glGetProgramBinary(GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat,
void *binary)
{
...
/*
void APIENTRY_FPE4ES fpe4es_glProgramBinary(GLuint program, GLenum binaryFormat, const void *binary, GLsizei length)
{
    if(hardext.prgbin_n==0) {
        errorShim(GL_INVALID_OPERATION);
        return;
    ...
    if(fpe4es_useProgramBinary(program, length, binaryFormat, binary))
        noerrorShim();
    else
        errorShim(GL_INVALID_OPERATION);
}*/
...
void APIENTRY_FPE4ES fpe4es_glLinkProgram(GLuint program) {
    ...
    if (!glprogram->last_vert) {
        ...
        GLenum vtx = fpe4es_glCreateShader(GL_VERTEX_SHADER);
        fpe4es_glShaderSource(vtx, 1, fpe_VertexShader(&needs, NULL), NULL);
        fpe4es_glCompileShader(vtx);
        fpe4es_glAttachShader(glprogram->id, vtx);
    }
    ...
    if (!glprogram->last_frag) {
        ...
        GLenum vtx = fpe4es_glCreateShader(GL_FRAGMENT_SHADER);
        fpe4es_glShaderSource(vtx, 1, fpe_FragmentShader(&needs, NULL), NULL);
        fpe4es_glCompileShader(vtx);
        fpe4es_glAttachShader(glprogram->id, vtx);
    }
    int compatible = 1;
    ...
    if (glprogram->last_vert)
        for (int i = 0; i < ATT_MAX; ++i) {
            ...
            if (attribute) fpe4es_glBindAttribLocation(glprogram->id, i, attribute);
        }
...
/*
AliasExport(void,glGetProgramBinary,,(GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, void
*binary)); AliasExport(void,glProgramBinary,,(GLuint program, GLenum binaryFormat, const void *binary, GLsizei
length));*/
...
GLvoid APIENTRY_FPE4ES fpe4es_glDeleteObject(GLhandleARB obj) {
    ...
    if (glprogram)
        fpe4es_glDeleteProgram(obj);
    else
        fpe4es_glDeleteShader(obj);
}
...
GLvoid APIENTRY_FPE4ES fpe4es_glGetObjectParameterfv(GLhandleARB obj, GLenum pname, GLfloat* params) {
    ...
    GLint p[4];
    if (glprogram)
        fpe4es_glGetProgramiv(obj, pname, p);
    else
        fpe4es_glGetShaderiv(obj, pname, p);
...
GLvoid APIENTRY_FPE4ES fpe4es_glGetObjectParameteriv(GLhandleARB obj, GLenum pname, GLint* params) {
    ...
    if (glprogram)
        fpe4es_glGetProgramiv(obj, pname, params);
    else
        fpe4es_glGetShaderiv(obj, pname, params);
...
GLvoid APIENTRY_FPE4ES fpe4es_glGetInfoLog(GLhandleARB obj, GLsizei maxLength, GLsizei* length, GLcharARB* infoLog) {
    ...
    if (glprogram)
        fpe4es_glGetProgramInfoLog(obj, maxLength, length, infoLog);
    else
        fpe4es_glGetShaderInfoLog(obj, maxLength, length, infoLog);
}

GLvoid APIENTRY_FPE4ES fpe4es_glGetAttachedObjects(GLhandleARB containerObj, GLsizei maxCount, GLsizei* count,
                                                   GLhandleARB* obj) {
    fpe4es_glGetAttachedShaders(containerObj, maxCount, count, obj);
}
