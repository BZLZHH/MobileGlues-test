...
void APIENTRY_FPE4ES fpe4es_glVertexPointer(GLint size, GLenum type, GLsizei stride, const GLvoid* pointer) {
...
void APIENTRY_FPE4ES fpe4es_glColorPointer(GLint size, GLenum type, GLsizei stride, const GLvoid* pointer) {
...
void APIENTRY_FPE4ES fpe4es_glNormalPointer(GLenum type, GLsizei stride, const GLvoid* pointer) {
...
void APIENTRY_FPE4ES fpe4es_glTexCoordPointer(GLint size, GLenum type, GLsizei stride, const GLvoid* pointer) {
...
void APIENTRY_FPE4ES fpe4es_glFogCoordPointer(GLenum type, GLsizei stride, const GLvoid* pointer) {
...
void APIENTRY_FPE4ES fpe4es_glInterleavedArrays(GLenum format, GLsizei stride, const GLvoid* pointer) {
    ...
    if (tex) {
        fpe4es_glEnableClientState(GL_TEXTURE_COORD_ARRAY);
        fpe4es_glTexCoordPointer(tex, tf, stride, (GLvoid*)ptr);
        ptr += tex * gl_sizeof(tf);
    }
    if (color) {
        fpe4es_glEnableClientState(GL_COLOR_ARRAY);
        fpe4es_glColorPointer(color, cf, stride, (GLvoid*)ptr);
        ptr += color * gl_sizeof(cf);
    }
    if (normal) {
        fpe4es_glEnableClientState(GL_NORMAL_ARRAY);
        fpe4es_glNormalPointer(nf, stride, (GLvoid*)ptr);
        ptr += normal * gl_sizeof(nf);
    }
    if (vert) {
        fpe4es_glEnableClientState(GL_VERTEX_ARRAY);
        fpe4es_glVertexPointer(vert, vf, stride, (GLvoid*)ptr);
    }
}
...
void APIENTRY_FPE4ES fpe4es_glEnd(void) {
    ...
    if (withColor) fpe4es_glColor4f(glstate->color[0], glstate->color[1], glstate->color[2], glstate->color[3]);
    noerrorShim();
}
    ...
    if (glstate->list.active) {
        if (glstate->list.active->stage != STAGE_DRAW) {
            ...
            if (!glstate->list.pending)
                return fpe4es_glNormal3f(v[0], v[1], v[2]); // this will put the call on the stack in the current list
        } else {
...
void APIENTRY_FPE4ES fpe4es_glColor4f(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha) {
    if (glstate->list.active) {
        ...
        fpe_glColor4f(red, green, blue, alpha);
    }
...
void APIENTRY_FPE4ES fpe4es_glColor4fv(GLfloat* v) {
    if (glstate->list.active) {
        if (glstate->list.active->stage != STAGE_DRAW) {
            if (glstate->list.compiling || glstate->list.active->stage < STAGE_DRAW) {
            ...
            if (!glstate->list.pending) return fpe4es_glColor4f(v[0], v[1], v[2], v[3]);
        } else {
            rlColor4fv(glstate->list.active, v);
            noerrorShimNoPurge();
        }
    } else {
        fpe_glColor4f(v[0], v[1], v[2], v[3]);
    }
    // change the state last thing
...
void APIENTRY_FPE4ES fpe4es_glMultiTexCoord2fv(GLenum target, GLfloat* v) {
    // TODO, error if target is unsuported texture....
    if (glstate->list.active) {
        if (glstate->list.pending)
            fpe4es_flush();
...
void APIENTRY_FPE4ES fpe4es_glMultiTexCoord4fv(GLenum target, GLfloat* v) {
    // TODO, error if target is unsuported texture....
    if (glstate->list.active) {
        if (glstate->list.pending)
            fpe4es_flush();
...
void APIENTRY_FPE4ES fpe4es_glArrayElement(GLint i) {
    ...
    if (p->enabled) {
        ...
        if (p->type == GL_FLOAT) {
            ...
            if (size == 3)
                fpe4es_glColor3ubv(b);
            else
                fpe4es_glColor4ubv(b);
        } else {
    ...
    if (p->enabled) {
        ...
        if (size < 4)
            fpe4es_glTexCoord2fv(v);
        else
            fpe4es_glTexCoord4fv(v);
    }
    for (int a = 1; a < vao->maxtex; a++) {
        ...
        if (p->enabled) {
            ...
            if (p->size < 4)
                fpe4es_glMultiTexCoord2fv(GL_TEXTURE0 + a, v);
            else
                fpe4es_glMultiTexCoord4fv(GL_TEXTURE0 + a, v);
        }
    }
    ...
    if (p->enabled) {
        ...
        if (p->size == 4) {
            fpe4es_glVertex4fv(v);
        } else if (p->size == 3) {
            fpe4es_glVertex3fv(v);
        } else {
            fpe4es_glVertex2fv(v);
        }
    }
}
...
// move "master" data if there
    ...
    fpe4es_scratch_vertex(total); // alloc if needed and bind scratch vertex buffer
...
static renderlist_t* fpe4es_glGetList(GLuint list) {
    khint_t k;
...
void APIENTRY_FPE4ES fpe4es_glCallList(GLuint list) {
    noerrorShim();
    if (glstate->list.active) {
        glstate->list.active = append_calllist(glstate->list.active, fpe4es_glGetList(list));
        return;
    }
    // TODO: the output of this call can be compiled into another display list
    renderlist_t* l = fpe4es_glGetList(list);
...
void APIENTRY_FPE4ES glPushCall(void* call) {
    if (glstate->list.active) {
        ...
        rlPushCall(glstate->list.active, (packed_call_t*)call);
    }
}
...
#define call(name, type)                                                                                               \
    case name:                                                                                                         \
        fpe4es_glCallList(((type*)lists)[i] + glstate->list.base);                                                     \
        break
...
#define call_bytes(name, stride)                                                                                       \
    case name:                                                                                                         \
        ...
        fpe4es_glCallList(list + glstate->list.base);                                                                  \
        break
...
void APIENTRY_FPE4ES fpe4es_glDeleteList(GLuint list) {
...
void APIENTRY_FPE4ES fpe4es_glShadeModel(GLenum mode) {
...
void APIENTRY_FPE4ES fpe4es_glAlphaFunc(GLenum func, GLclampf ref) {
    ...
    fpe_glAlphaFunc(func, ref);
}
AliasExport(void, glAlphaFunc, , (GLenum func, GLclampf ref));

void APIENTRY_FPE4ES fpe4es_glLogicOp(GLenum opcode) {
...
void APIENTRY_FPE4ES fpe4es_glColorMask(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) {
...
void APIENTRY_FPE4ES fpe4es_glClear(GLbitfield mask) {
...
void APIENTRY_FPE4ES fpe4es_glClampColor(GLenum target, GLenum clamp) {
...
void fpe4es_scratch_vertex(int alloc) {
    if (!glstate->scratch_vertex) {
        GLES.glGenBuffers(1, &glstate->scratch_vertex);
    }
    if (glstate->scratch_vertex_size < alloc) {
        bindBuffer(GL_ARRAY_BUFFER, glstate->scratch_vertex);
        GLES.glBufferData(GL_ARRAY_BUFFER, alloc, NULL, GL_STREAM_DRAW);
        glstate->scratch_vertex_size = alloc;
    } else {
        bindBuffer(GL_ARRAY_BUFFER, glstate->scratch_vertex);
        GLES.glBindBuffer(GL_ARRAY_BUFFER, glstate->scratch_vertex);
    }
}
...
void fpe4es_scratch_indices(int alloc) {
    if (!glstate->scratch_indices) {
        GLES.glGenBuffers(1, &glstate->scratch_indices);
    }
    bindBuffer(GL_ELEMENT_ARRAY_BUFFER, glstate->scratch_indices);
    GLES.glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, glstate->scratch_indices);
    if (glstate->scratch_indices_size < alloc) {
        GLES.glBufferData(GL_ELEMENT_ARRAY_BUFFER, alloc, NULL, GL_DYNAMIC_DRAW);
...
void amiga_pre_swap()
#else
NonAliasExportDecl(void, fpe4es_pre_swap, ())
#endif
{
    if (glstate->list.active) fpe4es_flush();
    if (glstate->raster.bm_drawing) bitmap_flush();
...
#else
NonAliasExportDecl(void, fpe4es_post_swap, ())
#endif
{
    show_fps();
