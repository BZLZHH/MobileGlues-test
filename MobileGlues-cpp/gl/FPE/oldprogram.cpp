...
void freeOldProgram(oldprogram_t* old)
{
    ...
    if(old->string)
        free(old->string);
    if(old->shader)
        fpe4es_glDeleteShader(old->shader->id);
...
/*
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1sARB(GLuint index, GLshort x)
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1fARB(GLuint index, GLfloat x);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1dARB(GLuint index, GLdouble x);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2sARB(GLuint index, GLshort x, GLshort y);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2fARB(GLuint index, GLfloat x, GLfloat y);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2dARB(GLuint index, GLdouble x, GLdouble y);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3sARB(GLuint index, GLshort x, GLshort y, GLshort z);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3fARB(GLuint index, GLfloat x, GLfloat y, GLfloat z);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3dARB(GLuint index, GLdouble x, GLdouble y, GLdouble z);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4sARB(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4fARB(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4dARB(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4NubARB(GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1svARB(GLuint index, const GLshort *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1fvARB(GLuint index, const GLfloat *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib1dvARB(GLuint index, const GLdouble *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2svARB(GLuint index, const GLshort *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2fvARB(GLuint index, const GLfloat *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib2dvARB(GLuint index, const GLdouble *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3svARB(GLuint index, const GLshort *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3fvARB(GLuint index, const GLfloat *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib3dvARB(GLuint index, const GLdouble *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4bvARB(GLuint index, const GLbyte *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4svARB(GLuint index, const GLshort *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4ivARB(GLuint index, const GLint *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4ubvARB(GLuint index, const GLubyte *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4usvARB(GLuint index, const GLushort *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4uivARB(GLuint index, const GLuint *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4fvARB(GLuint index, const GLfloat *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4dvARB(GLuint index, const GLdouble *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4NbvARB(GLuint index, const GLbyte *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4NsvARB(GLuint index, const GLshort *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4NivARB(GLuint index, const GLint *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4NubvARB(GLuint index, const GLubyte *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4NusvARB(GLuint index, const GLushort *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttrib4NuivARB(GLuint index, const GLuint *v);
void APIENTRY_FPE4ES fpe4es_glVertexAttribPointerARB(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer);
void APIENTRY_FPE4ES fpe4es_glEnableVertexAttribArrayARB(GLuint index);
void APIENTRY_FPE4ES fpe4es_glDisableVertexAttribArrayARB(GLuint index);
*/

void APIENTRY_FPE4ES fpe4es_glProgramStringARB(GLenum target, GLenum format, GLsizei len, const GLvoid *string) {
    ...
    // Convert to GLSL
    const GLchar * p[1] = {0};
    p[0] = fpe4es_convertARB(old->string, vertex, &glstate->glsl->error_msg, &glstate->glsl->error_ptr);
    if((!p[0]) || (glstate->glsl->error_ptr!=-1)) {
        DBG(printf("Error with ARB->GLSL conversion\nsource is:\n%s\n======\n", old->shader->source);)
        errorShim(GL_INVALID_OPERATION);
        return;
    }
    fpe4es_glShaderSource(old->shader->id, 1, p , NULL);
    ...
    fpe4es_glCompileShader(old->shader->id);
    GLint res = 0;
    fpe4es_glGetShaderiv(old->shader->id, GL_COMPILE_STATUS, &res);
    if(res!=GL_TRUE) {
...
void APIENTRY_FPE4ES fpe4es_glBindProgramARB(GLenum target, GLuint program) {
        ...
        case GL_VERTEX_PROGRAM_ARB:
            if(program) {
                ...
                if(!old->type) {
                    ...
                    old->type = target;
                    GLuint shader = fpe4es_glCreateShader(GL_VERTEX_SHADER);
        ...
        case GL_FRAGMENT_PROGRAM_ARB:
            if(program) {
                ...
                if(!old->type) {
                    // create an empty shader
                    old->type = target;
                    GLuint shader = fpe4es_glCreateShader(GL_FRAGMENT_SHADER);
                    shader_t *glshader = NULL;
                    khash_t(shaderlist) *shaders = glstate->glsl->shaders;
                    k = kh_get(shaderlist, shaders, shader);
                    glshader = kh_value(shaders, k);
...
void APIENTRY_FPE4ES fpe4es_glDeleteProgramsARB(GLsizei n, const GLuint *programs) {
...
void APIENTRY_FPE4ES fpe4es_glGenProgramsARB(GLsizei n, GLuint *programs) {
...
void APIENTRY_FPE4ES fpe4es_glProgramEnvParameter4dARB(GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) {
...
void APIENTRY_FPE4ES fpe4es_glProgramEnvParameter4dvARB(GLenum target, GLuint index, const GLdouble *params) {
...
void APIENTRY_FPE4ES fpe4es_glProgramEnvParameter4fARB(GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
...
void APIENTRY_FPE4ES fpe4es_glProgramEnvParameter4fvARB(GLenum target, GLuint index, const GLfloat *params)  {
...
void APIENTRY_FPE4ES fpe4es_glProgramLocalParameter4dARB(GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) {
...
void APIENTRY_FPE4ES fpe4es_glProgramLocalParameter4dvARB(GLenum target, GLuint index, const GLdouble *params) {
...
void APIENTRY_FPE4ES fpe4es_glProgramLocalParameter4fARB(GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
...
void APIENTRY_FPE4ES fpe4es_glProgramLocalParameter4fvARB(GLenum target, GLuint index, const GLfloat *params) {
...
void APIENTRY_FPE4ES fpe4es_glGetProgramEnvParameterdvARB(GLenum target, GLuint index, GLdouble *params)  {
...
void APIENTRY_FPE4ES fpe4es_glGetProgramEnvParameterfvARB(GLenum target, GLuint index, GLfloat *params) {
...
void APIENTRY_FPE4ES fpe4es_glGetProgramLocalParameterdvARB(GLenum target, GLuint index, GLdouble *params) {
...
void APIENTRY_FPE4ES fpe4es_glGetProgramLocalParameterfvARB(GLenum target, GLuint index, GLfloat *params) {
...
void APIENTRY_FPE4ES fpe4es_glGetProgramivARB(GLenum target, GLenum pname, GLint *params) {
...
void APIENTRY_FPE4ES fpe4es_glGetProgramStringARB(GLenum target, GLenum pname, GLvoid *string) {
...
void APIENTRY_FPE4ES fpe4es_glGetVertexAttribdvARB(GLuint index, GLenum pname, GLdouble *params);
void APIENTRY_FPE4ES fpe4es_glGetVertexAttribfvARB(GLuint index, GLenum pname, GLfloat *params);
void APIENTRY_FPE4ES fpe4es_glGetVertexAttribivARB(GLuint index, GLenum pname, GLint *params);

void APIENTRY_FPE4ES fpe4es_glGetVertexAttribPointervARB(GLuint index, GLenum pname, GLvoid **pointer);
*/

GLboolean APIENTRY_FPE4ES fpe4es_glIsProgramARB(GLuint program) {
...
void APIENTRY_FPE4ES fpe4es_glProgramEnvParameters4fvEXT(GLenum target, GLuint index, GLsizei count, const GLfloat *params)
{
...
void APIENTRY_FPE4ES fpe4es_glProgramLocalParameters4fvEXT(GLenum target, GLuint index, GLsizei count, const GLfloat *params)
{
