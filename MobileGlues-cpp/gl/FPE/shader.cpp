...
GLuint APIENTRY_FPE4ES fpe4es_glCreateShader(GLenum shaderType) {
...
void APIENTRY_FPE4ES fpe4es_glDeleteShader(GLuint shader) {
...
void APIENTRY_FPE4ES fpe4es_glCompileShader(GLuint shader) {
...
void APIENTRY_FPE4ES fpe4es_glShaderSource(GLuint shader, GLsizei count, const GLchar* const* string,
                                          const GLint* length) {
    ...
    if (gles_glShaderSource) {
        ...
        if (glstate->glsl->es2 && !strncmp(glshader->source, "#version 100", 12))
            ...
            glshader->converted =
                ConvertShader(glshader->source, glshader->type == GL_VERTEX_SHADER ? 1 : 0, &glshader->need);
...
void redoShader(GLuint shader, shaderconv_need_t* need) {
    ...
    // recompile...
    fpe4es_glCompileShader(glshader->id);
}

void APIENTRY_FPE4ES fpe4es_glGetShaderSource(GLuint shader, GLsizei bufSize, GLsizei* length, GLchar* source) {
...
GLboolean APIENTRY_FPE4ES fpe4es_glIsShader(GLuint shader) {
...
void APIENTRY_FPE4ES fpe4es_glGetShaderInfoLog(GLuint shader, GLsizei maxLength, GLsizei* length, GLchar* infoLog) {
...
void APIENTRY_FPE4ES fpe4es_glGetShaderiv(GLuint shader, GLenum pname, GLint* params) {
...
void APIENTRY_FPE4ES fpe4es_glGetShaderPrecisionFormat(GLenum shaderType, GLenum precisionType, GLint* range,
                                                      GLint* precision) {
...
void APIENTRY_FPE4ES fpe4es_glShaderBinary(GLsizei count, const GLuint* shaders, GLenum binaryFormat, const void* binary,
                                          GLsizei length) {
...
void APIENTRY_FPE4ES fpe4es_glReleaseShaderCompiler(void) {
...
GLhandleARB APIENTRY_FPE4ES fpe4es_glCreateShaderObject(GLenum shaderType) {
    return fpe4es_glCreateShader(shaderType);
}
