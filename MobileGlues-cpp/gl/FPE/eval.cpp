...
void APIENTRY_FPE4ES fpe4es_glMap1d(GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder,
...
void APIENTRY_FPE4ES fpe4es_glMap1f(GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder,
...
void APIENTRY_FPE4ES fpe4es_glMap2d(GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1,
...
void APIENTRY_FPE4ES fpe4es_glMap2f(GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1,
...
#define iter_maps(d, code)                                                                                             \
    ...
    if (!glstate->enable.auto_normal) p_map(d, normal, glNormal3f, code);                                              \
    p_map(d, texture4, glTexCoord4f, code) else p_map(d, texture3, glTexCoord3f, code) else p_map(                     \
        d, texture2, glTexCoord2f, code) else p_map(d, texture1, glTexCoord1f, code);                                  \
    p_map(d, vertex4, glVertex4f, code) else p_map(d, vertex3, glVertex3f, code);

void APIENTRY_FPE4ES fpe4es_glEvalCoord1f(GLfloat u) {
    noerrorShim();
    GLfloat out[4];
    iter_maps(1, GLfloat uu = (u - map->u._1) * map->u.d;
              _math_horner_bezier_curve((GLfloat*)map->points, out, uu, map->width, map->u.order);)
}

void APIENTRY_FPE4ES fpe4es_glEvalCoord2f(GLfloat u, GLfloat v) {
    noerrorShim();
    GLfloat out[4];
    iter_maps(
        2, GLfloat uu = (u - map->u._1) * map->u.d; GLfloat vv = (v - map->v._1) * map->v.d;
        if (glstate->enable.auto_normal &&
            (map == (map_statef_t*)glstate->map2.vertex3 || map == (map_statef_t*)glstate->map2.vertex4)) {
            GLfloat norm[3];
            GLfloat du[4];
            GLfloat dv[4];
            memset(out, 0, 3 * sizeof(GLfloat));
            out[3] = 1.0f;
            _math_de_casteljau_surf((GLfloat*)map->points, out, du, dv, uu, vv, map->width, map->u.order, map->v.order);
            if (map->width == 4) {
            ...
            fpe4es_glNormal3fv(norm);
        } else _math_horner_bezier_surf((GLfloat*)map->points, out, uu, vv, map->width, map->u.order, map->v.order);)
}

#undef p_map
#undef iter_maps

void APIENTRY_FPE4ES fpe4es_glMapGrid1f(GLint un, GLfloat u1, GLfloat u2) {
    if (un < 1) {
...
void APIENTRY_FPE4ES fpe4es_glMapGrid2f(GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2) {
...
void APIENTRY_FPE4ES fpe4es_glEvalMesh1(GLenum mode, GLint i1, GLint i2) {
...
void APIENTRY_FPE4ES fpe4es_glEvalMesh2(GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2) {
    GLenum renderMode = eval_mesh_prep(mode);
    if (!renderMode) {
        errorShim(GL_INVALID_ENUM);
        return;
...
void APIENTRY_FPE4ES fpe4es_glEvalPoint1(GLint i) {
    fpe4es_glEvalCoord1f(glstate->map_grid[0]._1 + glstate->map_grid[0].d * i);
}

void APIENTRY_FPE4ES fpe4es_glEvalPoint2(GLint i, GLint j) {
    fpe4es_glEvalCoord2f(glstate->map_grid[0]._1 + glstate->map_grid[0].d * i,
                         glstate->map_grid[1]._1 + glstate->map_grid[1].d * j);
}

#define GL_GET_MAP(t, type)                                                                                            \
    void APIENTRY_FPE4ES fpe4es_glGetMap##t##v(GLenum target, GLenum query, type* v) {                                 \
        noerrorShim();                                                                                                 \
...
// Direct wrapper
AliasExport_M(void, glMap1d, ,
              (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble* points), 32);
AliasExport(void, glMap1f, , (GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat* points));
AliasExport_M(void, glMap2d, ,
              (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2,
               GLint vstride, GLint vorder, const GLdouble* points),
              56);
AliasExport(void, glMap2f, ,
